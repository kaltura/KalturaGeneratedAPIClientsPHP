 ...
 * @subpackage Client
 */
class KalturaThumbnailService extends KalturaServiceBase
{
 ...
 * @subpackage Client
 */
class KalturaThumbnailClientPlugin extends KalturaClientPlugin
{
	/**
	...
	{
		parent::__construct($client);
		$this->thumbnail = new KalturaThumbnailService($client);
	}
	...
	{
		return new KalturaThumbnailClientPlugin($client);
	}
